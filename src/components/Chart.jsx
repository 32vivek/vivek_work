...
import { Typography, Grid, Paper, FormControl } from '@mui/material';
    ...
    return (
        <>
            <div style={{ position: 'relative' }} >
                <Grid container spacing={1} display="flex" justifyContent="center" alignItems="center" marginTop="100px">
